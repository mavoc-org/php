        ...
        <div id="app" class="columns_2">
            ...
            <main>
                <div id="content" class="page">
                    <h2>Settings</h2>
                    <p>All three of the settings endpoints are private and require a Premium account.</p>
                    ...
                    <div class="code">
                        <code>curl <?php esc(ao()->env('API_DOC_SITE')); ?>/api/v0/settings -u "<?php esc(ao()->env('API_DOC_USERNAME')); ?>:<?php esc(ao()->env('API_DOC_KEY')); ?>"</code>
                    </div>
                        ...
                        <pre>
{
  ...
  "data": {
    "timezone": "UTC"
					...
					<p>Below is a live example that can be copy and pasted.</p>
                    <div class="code">
                        <code>curl <?php esc(ao()->env('API_DOC_SITE')); ?>/api/v0/settings/timezones -u "<?php esc(ao()->env('API_DOC_USERNAME')); ?>:<?php esc(ao()->env('API_DOC_KEY')); ?>"</code>
                    </div>
                        ...
                        <pre>
{
  ...
  "messages": [],
  "meta": {
    "description": "This is a list of valid timezones."
  },
  "data": [
    "Africa/Abidjan",
    "Africa/Accra",
    ...
    "UTC"
					...
					<p>Below is a live example that can be copy and pasted.</p>
                    <div class="code">
                        <code>curl <?php esc(ao()->env('API_DOC_SITE')); ?>/api/v0/settings -u "<?php esc(ao()->env('API_DOC_USERNAME')); ?>:<?php esc(ao()->env('API_DOC_KEY')); ?>" -d "timezone=America/Chicago"</code>
                    </div>
